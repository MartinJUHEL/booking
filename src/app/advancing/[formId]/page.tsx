...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    key: "contacts", label: "Contacts", fields: [
      { key: "tourManager", label: "Tour manager", type: "text", placeholder: "Name" },
      { key: "tourManagerPhone", label: "Tour manager phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
      { key: "technician", label: "Technician", type: "text", placeholder: "Name" },
      { key: "technicianPhone", label: "Technician phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
      { key: "artistHandler", label: "Artist handler", type: "text", placeholder: "Name" },
      { key: "artistHandlerPhone", label: "Artist handler phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
      { key: "stageManager", label: "Stage manager", type: "text", placeholder: "Name" },
      { key: "stageManagerPhone", label: "Stage manager phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
    ],
  },
  {
  ...
  },
  {
    key: "dinner", label: "Dinner", fields: [
      ...
      { key: "dinnerDriver", label: "Driver name", type: "text" },
      { key: "dinnerDriverPhone", label: "Driver phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
    ],
  },
  {
    key: "arrival", label: "Arrival", fields: [
      ...
      { key: "arrivalDriver", label: "Driver name", type: "text" },
      { key: "arrivalDriverPhone", label: "Driver phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
  ...
  },
  {
    key: "showTransfers", label: "Show Transfers", fields: [
      ...
      { key: "transferToVenueDriver", label: "Driver name", type: "text" },
      { key: "transferToVenueDriverPhone", label: "Driver phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
      ...
      { key: "transferToHotelDriver", label: "Driver name", type: "text" },
      { key: "transferToHotelDriverPhone", label: "Driver phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
    ],
  },
  {
    key: "departure", label: "Departure", fields: [
      ...
      { key: "departureDriver", label: "Driver name", type: "text" },
      { key: "departureDriverPhone", label: "Driver phone", type: "tel", placeholder: "+33 6 00 00 00 00" },
